function Stitches(game, x, y) {
  ...
  this.forwardAnimation = new Animation(sheet, 290, 0, frameWidth, frameHeight, 0.2, 3, true, false);
  this.backwardAnimation = new Animation(sheet, 290, 96, frameWidth, frameHeight, 0.2, 3, true, false);
