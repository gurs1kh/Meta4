function SuitZombie(game, x, y) {
  ...
  this.forwardAnimation = new Animation(sheet, 96, 128, frameWidth, frameHeight, 0.2, 3, true, false);
  this.backwardAnimation = new Animation(sheet, 96, 224, frameWidth, frameHeight, 0.2, 3, true, false);
