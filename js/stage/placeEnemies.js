...
PlaceEnemies.prototype.placeDark = function () {
  ...
  for (var i = 0; i < this.num / 4; i++) {
    ...
    var locations = {0:getlocationDark(2500, 3200, 2500, 3200, 1), //quadrant 1
                      1:getlocationDark(3200, 3900, 2500, 3200, 2), //quadrant 2
                      2:getlocationDark(2500, 3200, 3200, 3900, 3), //quadrant 3
                      3:getlocationDark(3200, 3900, 3200, 3900, 4)  //quadrant 4
                    };
    for (var j = 0; j < 4; j++) {
      var dark;
      var which = getRandomNumber(0, 1);
